...
/**
 * Defines a generic type for HTML element attributes
 */
export type ElementAttributes<T extends GlobalAttributes> = Partial<
  Record<keyof T, string | boolean | number>
>;

// export type ElementAttributes<T extends HTMLElement> = T extends HTMLElement
//   ? {
//     [K in keyof T]?: T[K];
//   }
//   : never;
